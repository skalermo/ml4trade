...
class TestSimulationEnv(unittest.TestCase):
    def test_prev_step_returns_on_scheduling_time(self):
        ...
        env = setup_default_simulation_env(start_datetime=start_datetime, scheduling_time=scheduling_time)
    ...
    def test_time_flows_independently_in_envs(self):
        start_datetime = START_TIME
        env1 = setup_default_simulation_env(start_datetime=start_datetime)
        env2 = setup_default_simulation_env(start_datetime=start_datetime)
